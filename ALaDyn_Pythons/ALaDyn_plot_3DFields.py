...
if __name__ == '__main__':
	...
	for i in range(frame_begin, frame_end+1 ):
		...
		np.savetxt( os.path.join(path_write,'data','E_field',('Ex_tot_3D_'+('%2.2i'%i)+'.txt')),Exf+Exb)
		np.savetxt( os.path.join(path_write,'data','E_field',('Ey_tot_3D_'+('%2.2i'%i)+'.txt')),Eyf+Eyb)
		np.savetxt( os.path.join(path_write,'data','E_field',('Ez_tot_3D_'+('%2.2i'%i)+'.txt')),Ezf+Ezb)
        ...
        np.savetxt( os.path.join(path_write,'data','B_field',('Bx_tot_3D_'+('%2.2i'%i)+'.txt')),Exf)
        np.savetxt( os.path.join(path_write,'data','B_field',('By_tot_3D_'+('%2.2i'%i)+'.txt')),Byf+Byb)
        np.savetxt( os.path.join(path_write,'data','B_field',('Bz_tot_3D_'+('%2.2i'%i)+'.txt')),Bzf+Bzb)