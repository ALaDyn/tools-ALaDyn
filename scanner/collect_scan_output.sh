...
if [ ${DO_SCAN} ] 
then
 ./scanner -in energy_scan.txt -out energy_scan_0.5.txt -select 2 0.5
 ./scanner -in energy_scan.txt -out energy_scan_1.0.txt -select 2 1.0
 ./scanner -in energy_scan.txt -out energy_scan_1.5.txt -select 2 1.5
 ./scanner -in energy_scan.txt -out energy_scan_2.0.txt -select 2 2.0
 ./scanner -in energy_scan.txt -out energy_scan_2.5.txt -select 2 2.5
 ./scanner -in energy_scan.txt -out energy_scan_3.0.txt -select 2 3.0
else 
