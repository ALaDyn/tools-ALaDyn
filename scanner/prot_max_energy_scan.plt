...
set cblabel 'Maximum proton energy (MeV)'
#set size ratio -1
set xrange[0.5:3.5]
set yrange[0:1]
#set cbrange[2.0:4.0]
...
FILE_OUT="max_energy_scan_Hion_2.0.png"
set output FILE_OUT
