...
set cblabel 'Average electron temperature (MeV)'
#set size ratio -1
set xrange[0.5:3.5]
set yrange[0:1]
#set cbrange[20:75]
...
FILE_OUT="ave_energy_scan_Electron_2.0.png"
set output FILE_OUT
