...
set cblabel 'Total electron energy ({/Symbol.ttf m}J)'
#set size ratio -1
set xrange[0.5:3.5]
set yrange[0:1]
...
FILE_OUT="tot_energy_scan_Electron_2.0.png"
set output FILE_OUT
