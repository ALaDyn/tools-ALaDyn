...
int leggi_campi(int argc, const char** argv, Parametri * parametri)
{
  ...
  int npe_y = 0, npe_z = 0, nx1 = 0, ny1 = 0, nz1 = 0;
  size_t nxloc = 0, nyloc = 0, nzloc = 0;
  ...
  if (npunti_z == 1 && out_lineoutx)
  {
    ...
    for (size_t i = 0; i < npunti_x; i++) x_lineout[i] = 0;
  ...
  if (out_vtk_nostretch)
  {
    ...
    {
      if (parametri->stretched_along_x) inizio_punti_non_stretchati_x = (int)(npunti_x / 6.0);
      ...
      if (parametri->stretched_along_x) fine_punti_non_stretchati_x = (int)(npunti_x*5.0 / 6.0);
      else fine_punti_non_stretchati_x = (int)(npunti_x);
